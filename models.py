...
class HSimplE(torch.nn.Module):
    ...
    def forward(self, r_idx, e1_idx, e2_idx, e3_idx, e4_idx, e5_idx, e6_idx):
        ...
        print("@@@@@@@@")
        #print("REL:", r)
        #print("SIZE:", self.E(e2_idx).shape)
        #print("SIZE IDX:", e2_idx.shape)
        #print("IDX 2:", e2_idx)
        #print("IDX 5:", e5_idx)
        #print("POS 2:", self.E(e2_idx))
        #print("POS 5:", self.E(e5_idx))
        #print("POS 6:", self.E(e6_idx))
        e2 = self.shift(self.E(e2_idx), int(1 * self.emb_dim/6))
        e3 = self.shift(self.E(e3_idx), int(2 * self.emb_dim/6))
        e4 = self.shift(self.E(e4_idx), int(3 * self.emb_dim/6))
        e5 = self.shift(self.E(e5_idx), int(4 * self.emb_dim/6))
        e6 = self.shift(self.E(e6_idx), int(5 * self.emb_dim/6))
        #print("POS 2:", e2)
        #print("POS 5:", e5)
        #print("POS 6:", e6)
        #print("X====:", x)
